...
Page({
  ...
  onLoad: function (options) {
    app.signIsLogin((res)=>{
      ...
      let pageCom = this.getPageComponent(page, 'market');
      if(pageCom){
  ...
  wareTrayItemList(){
    ...
    Http.get(Config.api.wareTrayItemList, {
      ...
      let rd = res.data;
      addData.sale_out_plan_id = detail.id;
      let sumNum = 0;
