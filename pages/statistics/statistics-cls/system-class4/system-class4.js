...
Page({
    ...
    onLoad: function (options) {
        app.signIsLogin(() => {
            let { system_class1, system_class_code1, system_class2, system_class_code2, system_class3, system_class_code3, begin_date, end_date, province_code } = options;
            let { query } = this.data;
            query.province_code = province_code;
            query.begin_date = begin_date;
            query.end_date = end_date;
            query.system_class = system_class3;
            query.system_class_code = system_class_code3;
            query.system_class2 = system_class2;
            query.system_class_code2 = system_class_code2;
    ...
    onItemClick(e) {
        ...
        let { query } = this.data;
        wx.navigateTo({
            url: "/pages/statistics/statistics-cls/system-class-item/system-class-item"
              ...
              + "&system_class3=" + query.system_class
              + "&system_class_code3=" + query.system_class_code
              + "&system_class4=" + item.item_system_class
              + "&system_class_code4=" + item.system_class_code
